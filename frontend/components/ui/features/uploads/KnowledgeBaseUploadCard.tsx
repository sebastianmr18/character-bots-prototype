...
type KnowledgeBaseUploadCardProps = {
  refreshKey: number
}

export function KnowledgeBaseUploadCard({ refreshKey }: KnowledgeBaseUploadCardProps) {
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            <Label htmlFor="kb-character-select">Personaje</Label>
            <select
