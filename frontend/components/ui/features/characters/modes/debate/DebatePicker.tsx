...
export function DebatePicker({ currentCharacterId, characters, onConfirm, isLoading, isLoadingCharacters }: DebatePickerProps) {
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            {filteredCharacters.length === 0 && !isLoadingCharacters && (
