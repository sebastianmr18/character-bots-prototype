  ...
  if (history.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-stone-400 opacity-60">
        ...
        <p className="text-xl italic font-serif text-stone-600">"Start your conversation"</p>
        <p className="text-xs mt-2 uppercase tracking-widest font-bold text-stone-500">Character Voice Call</p>
      </div>
    );
  }
